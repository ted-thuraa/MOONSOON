                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="mx-40 mt-20 mb-20">
                                            <form @submit.prevent="saveHostel">
            ...
            >
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="px-4 py-4">{{ hostel.hostel_name }}</td>
                        <td class="px-4 py-4">{{ hostel.location }}</td>
                        <td class="px-4 py-4">
                            <div
                                v-if="hostel.available"
                        ...
                        <td
                            class="px-4 py-4 flex flex-row items-start justify-center gap-x-1"
                        >
...
function onImageChange(ev) {
    ...
    reader.onload = () => {
        ...
        hostelDetails.thumbnailimage = reader.result;
...
function editHostel(Hostel) {
    hostelDetails.hostel_name = Hostel.hostel_name;
    hostelDetails.location = Hostel.location;
    hostelDetails.available = Hostel.available;
    hostelDetails.description = Hostel.description;
    hostelDetails.total_rooms = Hostel.total_rooms;
    hostelDetails.billing = Hostel.billing;
    thumbnail_url.value = room.thumbnailimage;

    isOpen.value = true;
}
const saveHostel = async (ev) => {
    //loading.value = true;
    //errorMsg.value = null;
    ev.preventDefault();
    //await userStore.getTokens();
    await store
        .dispatch("createNewHostel", hostelDetails)
        .then((data) => {
            console.log(data);
